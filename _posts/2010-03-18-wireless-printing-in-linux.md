...
---
<p>If you go to Uniprint's <a href="http://uniprint.osu.edu/printman/osuprintmap/">wireless printing</a> page, you'll see it is possible to print to most public printers from anywhere on OSU's network, such as osuwireless. However, Uniprint only supports Mac and Windows; Linux users are out of luck and left with the options of either installing a new operating system to print their documents or using a lab computer (if available). Therefore, we in the Open Source Club have decided to publish a tutorial so fellow Linux users can print to their libraries from their laptops or dorm rooms just like Windows/Mac users can.</p>

<p>First, we need to have CUPS installed. This is the default in many Linux distributions as far as I know. If it's not installed by default, please <a href="/comment/reply/241#comment-form">leave a comment</a>.</p>

<p>With CUPS installed, go to <a href="http://localhost:631/">http://localhost:631/</a> and click on <img src="/sites/default/files/button-add-printer_0.gif" alt="Add Printer"/>. Fill in your own description and pick a meaningful description location that you will remember later on (e.g. <i>Science & Engineering Library, Color Printer</i>). For the printer <b>Name</b>, you will want to look up your printer in the table below. Fill it in and click on <img src="/sites/default/files/button-continue_0.gif" />.</p>

<p>On the next page, select "<i>LPD/LPR Host or Printer</i>" for the device and click <img src="/sites/default/files/button-continue_0.gif" />. Now, for <b>Device URI</b>, fill in the URI shown in the table <a href="#printerlist">below</a>. For example, if I want to print to the printer in room 45 of Thompson Library, I would enter <u>lpd://128.146.12.138/li0045-hp4200mobile</u>. Now, select the printer's manufacturer (should be in the model name) for <a href="/sites/default/files/cups_manufacturer_page.png" rel="lightbox">Make</a>. If the instructions for your printer below mention uploading a PPD file instead of saying the model, upload it here; otherwise, in the <a href="/sites/default/files/cups_model_page.png" rel="lightbox">table that comes up</a> select the closest match to the corresponding printer model (listed below). When your web browser prompts you for a username and password, enter the administrative username/password for the computer you're on, or the username/password of some other user in the <code>lpadmin</code> group. You may be redirected to a page with a lot of optional configurations options. At this point all of your applications should be able to use that printer, and have it listed as one of your installed printers, but you may wish to customize your settings for it. Remember that you will still need to swipe your BuckID at the print station to pay for and release your print job.</p>

<p><b>Note:</b> The installers from Uniprint will install a <a href="/sites/default/files/pharos_popup.png" rel="lightbox">Popup Client</a> program, which asks for a username, password, and title. This is not (yet) possible for Linux. Instead, the username will be the username you're logged into your computer with and the title will be whatever the title is of what you're printing. There will be no password. This means that from the time you send your document to the printer queue, until the time you go and pick it up, anybody can swipe their ID to pick it up. <b><i><u>Do not send confidential or sensitive information</u></i></b> to the printer because it is not possible to password protect it, even though Uniprint's proprietary program will add a password.</p>
<br />
<br />
<style type="text/css">
table#printerlist {border-width:1px;}
...
<tr class="even">
<td title="The Ohio State University Baker Hall West">Baker Hall West<sup><a href="#residencehallrestricted">i</a></sup></td>
...
<td>(Upload <a href="/sites/default/files/stp-pcl-5.5.1.ppd">xrx7655.ppd</a><sup><abbr title="Upload this file into your CUPS interface instead of selecting a manufacturer"><a href="#untested">iii</a></abbr></sup> file)</td>
</tr>
<tr class="odd">
<td title="The Ohio State University Drackett Tower">Drackett Tower Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Drackett_Tower</td>
<td>lpd://128.146.217.231/drackettspool1</td>
<td>(Upload <a href="/sites/default/files/stp-pcl-5.5.1.ppd">stp-pcl-5.5.1.ppd</a><sup><abbr title="Upload this file into your CUPS interface instead of selecting a manufacturer"><a href="#untested">iii</a></abbr></sup> file)</td>
</tr>
<tr class="even">
<td title="Dreese Laboratories, Room 517">517 Dreese Lab<sup><a href="#labrestricted">ii</a></sup></td>
<td>DL517</td>
<td>"lpd://eceprint1.ece.ohio-state.edu/dl517mobile1</td>
<td>HP LaserJet 4300 Series</td>
</tr>
<tr class="odd">
<td title="Dreese Laboratories, Room 557">557 Dreese Lab<sup><a href="#labrestricted">ii</a></sup></td>
<td>DL557</td>
<td>lpd://eceprint1.ece.ohio-state.edu/dl557mobile1</td>
<td>HP LaserJet 4300 Series</td>
</tr>
<tr class="even">
<td title="Dreese Laboratories, Room 817">817 Dreese Lab<sup><a href="#labrestricted">ii</a></sup></td>
<td>DL817</td>
<td>lpd://eceprint1.ece.ohio-state.edu/dl817mobile1</td>
<td>HP LaserJet 4300 Series</td>
</tr>
<tr class="odd">
<td title="Caldwell Laboratory, Room 260">260 Caldwell Lab<sup><a href="#labrestricted">ii</a></sup></td>
<td>CL260</td>
...
<tr class="even">
<td title="OSU Hale Hall Rooms 0100 & 0135">Black Cultural Center<sup><a href="#labrestricted">ii</a></sup></td>
<td>BCC</td>
...
<tr class="odd">
<td title="328 W. Lane Ave, Lobby">Lane Ave Residence Hall<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Lane_Avenue</td>
<td>lpd://128.146.217.231/lanespool1</td>
<td>HP LaserJet 4000 Series</td>
</tr>
<tr class="even">
<td title="2nd Floor Drinko Hall">Law Library LaserJet 4200<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>LawHP4200</td>
<td>lpd://140.254.18.235/LawHP4200</td>
<td>HP LaserJet 4200 Series</td>
</tr>
<tr class="odd">
<td title="2nd Floor Drinko Hall">Law Library LaserJet 8150<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>LawHP8150</td>
<td>lpd://140.254.18.235/LawHP8150</td>
<td>HP LaserJet 8150 Series</td>
</tr>
<tr class="even">
<td title="Morrill Tower 3rd Floor">Morrill Tower Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Morrill_Tower</td>
<td>lpd://128.146.217.231/morrillspool1</td>
<td>HP LaserJet 4200 Series</td>
</tr>
<tr class="odd">
<td title="The Ohio State University Morrison Tower">Morrison Tower Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Morrison_Tower</td>
<td>lpd://128.146.217.231/morrisonspool1</td>
<td>HP LaserJet 4000 Series</td>
</tr>
<tr class="even">
<td title="Norton House 1st Floor">Norton House Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Norton_House</td>
<td>lpd://128.146.217.231/nortonspool1</td>
<td>HP LaserJet 4050 Series</td>
</tr>
<tr class="odd">
<td title="The Ohio State University Paterson Hall">Paterson Hall Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Paterson_Hall</td>
<td>lpd://128.146.217.231/patersonspool1</td>
<td>HP LaserJet 4100 Series</td>
</tr>
<tr class="even">
<td title="Pressey Hall Room 044">44 Pressey Hall Wireless Printer<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>SHSPHAROS-44</td>
...
<td>SEL120_Printers1<br />_3_BW</td>
...
<td>SEL120_Printer5<br />_Color</td>
...
<tr class="odd">
<td title="Steeb Hall 1st Floor">Steeb Hall Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Steeb_Hall</td>
...
<tr class="odd">
<td title="The Ohio State University Stradley Hall">Stradley Hall Lobby<sup><a href="#residencehallrestricted">i</a></sup></td>
<td>Stradley_Hall</td>
...
<td>(Upload "<a href="/sites/default/files/CNRC288X1.PPD" style="color:black;">CNRC288X1.PPD</a>")</td>
</tr>
<tr class="even">
...
<td>HP Color LaserJet 4700</td></td>
</tr>
</table>
<ol class="romanlist">
<li id="residencehallrestricted">Residence halls may be restricted to current on-campus residents, subject to OSU Housing's terms and conditions.</li>
<li id="labrestricted">Computer labs may be restricted to students of particular major(s) or on other factors at the discretion of department's IT service.</li>
<li id="untested">Some printers appear to require a PPD file and we have not yet ensured some particular instances will work.</li>
</ol>
